...
namespace ctll {
	...
	template <typename Actions> struct identity: public Actions {
		...
		template <typename Action, int V> constexpr static auto apply(Action, term<V>, empty_subject) -> empty_subject { return {}; }
	...
	template <typename Actions> struct ignore_unknown: public Actions {
		...
		template <typename Action, int V, typename Subject> constexpr static auto apply(Action, term<V>, Subject) -> Subject { return {}; }
