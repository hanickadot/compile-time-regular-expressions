...
template <> struct Static::Table<Grammar::NT_C,'$'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'('> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,')'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,','> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'-'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'.'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'0'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'1'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'2'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'3'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'4'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'5'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'6'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'7'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'8'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'9'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,':'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'['> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'\\'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,']'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'^'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'a'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'b'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'c'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'d'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'e'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'f'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
template <> struct Static::Table<Grammar::NT_C,'x'> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // last 
...
template <char c> struct Static::Table<Grammar::NT_C,c> { using Move = Static::String<Grammar::NT_altB, Static::Builder<make_catch>, Grammar::Term_close>; }; // other
