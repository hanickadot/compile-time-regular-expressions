#include <ctfa/transformations/remove_unneeded.hpp>
...
namespace one {
	...
	static constexpr auto fa = ctfa::remove_unneeded_one<fa1>::result;
...
namespace two {
	static constexpr auto fa1 = ctfa::finite_automaton<4, 1>{{
		ctfa::transition{ctfa::state{0}, ctfa::state{2}, ctfa::matcher::unit<'a'>},
		ctfa::transition{ctfa::state{1}, ctfa::state{2}, ctfa::matcher::unit<'a'>},
...
namespace none {
	static constexpr auto fa1 = ctfa::finite_automaton<0, 2>{{},{
		ctfa::state{0},
		ctfa::state{1}
	}};
	...
	static constexpr auto expected = ctfa::finite_automaton<0, 1>{{},{
		ctfa::state{0}
	}};
