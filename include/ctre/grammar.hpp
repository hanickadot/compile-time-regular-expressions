...
struct math_grammar {
	...
	struct add_variable: ctre::action {
	...
	struct add_constant: ctre::action {
...
struct math_grammar_quick {
	...
	RULE(E, range<'a','z'>) -> push<range<'a','z'>, add_variable, T2, E2>;
	RULE(E, range<'0','9'>) -> push<range<'0','9'>, add_constant, T2, E2>;
	...
	RULE(T, range<'a','z'>) -> push<range<'a','z'>, add_variable, T2>;
	RULE(T, range<'0','9'>) -> push<range<'0','9'>, add_constant, T2>;
